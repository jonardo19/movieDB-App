                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (controller.upComingMovie.isNotEmpty) {
                          Get.toNamed(
                              '${AppRouters.detailMovie}/${controller.upComingMovie[index].id}');
                        }
                      },
                      child: SizedBox(
                        width: 120,
                          ...
                          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8),
                                    child: Image.network(
                                      controller.upComingMovie[index]
                                              .posterPath!.isEmpty
                                          ? "https://mardizu.co.id/assets/images/client/default.png"
                                          : "${AppConstant.imageUrlW500}${controller.upComingMovie[index].posterPath}",
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                                Container(
                                  ...
                                  child: Text(
                                    controller.upComingMovie.isEmpty
                                        ? ""
                                        : "Rating ${controller.upComingMovie[index].voteAverage?.roundToDouble()}"
                                            .toString(),
                            ...
                            Visibility(
                              ...
                              child: Text(
                                controller.upComingMovie.isEmpty
                                    ? ""
                                    : "${controller.upComingMovie[index].originalTitle}",
                                style: const TextStyle(
